// CATALOGO DE FALTAS
// Module for managing the fault catalog

// Default catalog of faults
const FALTAS_PREDETERMINADAS = [
    ...
    { id: 'l58', codigo: '8.4', descripcion: 'Cambiar de sentido con +1 movimientos innecesarios', tipo: 'leve'},
    { id: 'l59', codigo: '8.4', descripcion: 'Cambiar de sentido golpeando el bordillo sin subir', tipo: 'leve'},
    { id: 'l60', codigo: '9.1', descripcion: 'Parar/estacionar sin observar', tipo: 'leve'},
    { id: 'l61', codigo: '9.2', descripcion: 'Parar/estacionar sin indicar', tipo: 'leve'},
    { id: 'l62', codigo: '9.2', descripcion: 'Parar/estacionar indicando sin antelación', tipo: 'leve'},
    { id: 'l63', codigo: '9.2', descripcion: 'Parar/estacionar indicando con demasiada antelación', tipo: 'leve'},
    { id: 'l64', codigo: '9.3', descripcion: 'Parar/estacionar en lugar prohibido por norma', tipo: 'leve'},
    { id: 'l65', codigo: '9.3', descripcion: 'Parar/estacionar en lugar claramente inferior, entrando parte posterior', tipo: 'leve'},
    { id: 'l66', codigo: '9.4', descripcion: 'Estacionar sin aprovechar espacio', tipo: 'leve'},
    { id: 'l67', codigo: '9.4', descripcion: 'Estacionar golpeando el bordillo sin subir', tipo: 'leve'},
    { id: 'l68', codigo: '9.4', descripcion: 'No poner freno de estacionamiento', tipo: 'leve'},
    { id: 'l69', codigo: '9.4', descripcion: 'No apagar el motor al estacionar', tipo: 'leve'},
    { id: 'l70', codigo: '9.4', descripcion: 'Abrir la puerta sin observar', tipo: 'leve'},
    { id: 'l71', codigo: '11.1', descripcion: 'Detenerse o no reanudar cuando el agente da paso', tipo: 'leve'},
    { id: 'l72', codigo: '11.2', descripcion: 'Rebasar barrera móvil sin causar peligro', tipo: 'leve'},
    { id: 'l73', codigo: '11.3', descripcion: 'Detenerse o no reanudar con semáforo con franja blanca vertical', tipo: 'leve'},
    { id: 'l74', codigo: '11.3', descripcion: 'Detenerse o no reanudar con semáforo verde o amarillo intermitente', tipo: 'leve'},
    { id: 'l75', codigo: '11.3', descripcion: 'No moderar velocidad con semáforo amarillo intermitente', tipo: 'leve'},
    { id: 'l76', codigo: '11.4', descripcion: 'Exceder velocidad específica en +10km/h', tipo: 'leve'},
    { id: 'l77', codigo: '11.4', descripcion: 'Incumplir señal de SEÑALES ACÚSTICAS PROHIBIDAS', tipo: 'leve'},
    { id: 'l78', codigo: '11.4', descripcion: 'No seguir dirección indicada por no observar señal de orientación', tipo: 'leve'},
    { id: 'l79', codigo: '11.5.1', descripcion: 'Circular sobre líneas discontínuas', tipo: 'leve'},
    { id: 'l80', codigo: '11.5.2', descripcion: 'Detenerse sin justificación sobre pasos de peatones o ciclistas', tipo: 'leve'},
    { id: 'l81', codigo: '11.5.2', descripcion: 'Rebasar línea de detención', tipo: 'leve'},
    { id: 'l82', codigo: '11.5.4', descripcion: 'Detenerse sobre cuadrícula amarilla', tipo: 'leve'},
    { id: 'l83', codigo: '12.2', descripcion: 'No usar alumbrado de posición siendo obligatorio', tipo: 'leve'},
    { id: 'l84', codigo: '12.3', descripcion: 'No usar alumbrado de cruce siendo obligatorio', tipo: 'leve'},
    { id: 'l85', codigo: '12.4', descripcion: 'No usar alumbrado de carretera siendo obligatorio', tipo: 'leve'},
    { id: 'l86', codigo: '12.5', descripcion: 'Usar luz antiniebla trasera sin las condiciones para ello', tipo: 'leve'},
    { id: 'l87', codigo: '12.6', descripcion: 'No usar luz de emergencia siendo obligatorio', tipo: 'leve'},
    { id: 'l88', codigo: '12.6', descripcion: 'Usar luz de emergencia sin las condiciones para ello', tipo: 'leve'},
    { id: 'l89', codigo: '13.1.1', descripcion: 'No conseguir arrancar el motor', tipo: 'leve'},
    { id: 'l90', codigo: '13.1.1', descripcion: 'Arrancar el motor con marcha puesta dando salto', tipo: 'leve'},
    { id: 'l91', codigo: '13.1.1', descripcion: 'Insistir en arrancar el motor cuando ya está en marcha', tipo: 'leve'},
    { id: 'l92', codigo: '13.1.1', descripcion: 'No apagar el motor cuando sea necesario', tipo: 'leve'},
    { id: 'l93', codigo: '13.1.2', descripcion: 'Pisar embrague sin justificación', tipo: 'leve'},
    { id: 'l94', codigo: '13.1.3', descripcion: 'Disminuir velocidad bruscamente por no frenar de forma progresiva', tipo: 'leve'},
    { id: 'l95', codigo: '13.1.4', descripcion: 'No acelerar de forma progresiva, suave y con decisión', tipo: 'leve'},
    { id: 'l96', codigo: '13.1.5', descripcion: 'No usar relación de marchas adecuada', tipo: 'leve'},
    { id: 'l97', codigo: '13.1.5', descripcion: 'Poner punto muerto antes de detenerse', tipo: 'leve'},
    { id: 'l98', codigo: '13.1.5', descripcion: 'No usar freno motor en descensos', tipo: 'leve'},
    { id: 'l99', codigo: '13.1.5', descripcion: 'Calado del motor por marcha no adecuada', tipo: 'leve'},
    { id: 'l100', codigo: '13.1.6', descripcion: 'No desactivar el freno de estacionamiento', tipo: 'leve'},
    { id: 'l101', codigo: '13.1.7', descripcion: 'Sujetar el volante con una mano', tipo: 'leve'},
    { id: 'l102', codigo: '13.1.7', descripcion: 'Ligeras desviaciones con dos manos o al cambiar de marcha', tipo: 'leve'},
    { id: 'l103', codigo: '13.1.7', descripcion: 'Giro brusco del volante por no percibir la trayectoria de la vía', tipo: 'leve'},
    { id: 'l104', codigo: '13.1.7', descripcion: 'Mantener las manos cruzadas al volante o sujetarlo por el interior', tipo: 'leve'},
    { id: 'l105', codigo: '13.1.8', descripcion: 'No realizar una conducción eficiente', tipo: 'leve'},
    { id: 'l106', codigo: '13.2.1', descripcion: 'Usar el embrague antes que el freno sin necesidad', tipo: 'leve'},
    { id: 'l107', codigo: '13.2.1', descripcion: 'Calado del motor', tipo: 'leve'},
    { id: 'l108', codigo: '13.2.1', descripcion: 'Acelerar en vacío', tipo: 'leve'},
    { id: 'l109', codigo: '13.2.2', descripcion: 'Arranque brusco o a saltos', tipo: 'leve'},
    { id: 'l110', codigo: '13.2.3', descripcion: 'Cambiar de marcha con brusquedad', tipo: 'leve'},
    { id: 'l111', codigo: '13.2.3', descripcion: 'Rascar marcha por no pisar bien el embrague', tipo: 'leve'},
    { id: 'l112', codigo: '13.2.3', descripcion: 'Reducir marcha y no soltar el embrague', tipo: 'leve'},
    { id: 'l113', codigo: '13.2.4', descripcion: 'Pisar embrague en curva o giro', tipo: 'leve'},
    { id: 'l114', codigo: '13.2.5', descripcion: 'Frenar en curva sin necesidad', tipo: 'leve'},
    { id: 'l115', codigo: '13.2.6', descripcion: 'Mantener pisado el acelerador mientras se cambia de marcha', tipo: 'leve'},
    { id: 'l116', codigo: '13.2.6', descripcion: 'Cambiar de marchas sin alcanzar las revoluciones necesarias', tipo: 'leve'},
    { id: 'l117', codigo: '14.1', descripcion: 'No usar el limpiaparabrisas cuando sea necesario', tipo: 'leve'},
    { id: 'l118', codigo: '14.2', descripcion: 'No usar el cláxon cuando sea necesario', tipo: 'leve'},
    { id: 'l119', codigo: '14.2', descripcion: 'Usar el cláxon de forma antirreglamentaria', tipo: 'leve'},
    { id: 'l120', codigo: '14.3', descripcion: 'Iniciar la marcha con puerta abierta', tipo: 'leve'},
    { id: 'l121', codigo: '14.4', descripcion: 'No usar los mandos relacionados con la visibilidad cuando sea necesario', tipo: 'leve'},
    { id: 'l122', codigo: '15.2', descripcion: 'Subir al bordillo con las ruedas traseras', tipo: 'leve'},
...
// Function to check and repair catalog integrity
function repararCatalogoFaltas() {
    try {
        const storedCatalog = localStorage.getItem('catalogoFaltas');
        if (!storedCatalog) return false;

        const faltas = JSON.parse(storedCatalog);
        if (!Array.isArray(faltas)) {
            console.error('Estructura de catálogo inválida');
            return false;
        }

        // Validar y reparar cada falta
        const faltasReparadas = faltas.map(falta => {
            // Asegurar que tenga todos los campos necesarios
            return {
                id: falta.id || `f${Date.now()}`,
                codigo: falta.codigo || '',
                descripcion: falta.descripcion || '',
                tipo: falta.tipo || 'leve',
                activa: typeof falta.activa === 'boolean' ? falta.activa : true
            };
        }).filter(falta => 
            falta.id && 
            typeof falta.codigo === 'string' &&
            typeof falta.descripcion === 'string' &&
            ['leve', 'deficiente', 'eliminatoria'].includes(falta.tipo.toLowerCase())
        );

        localStorage.setItem('catalogoFaltas', JSON.stringify(faltasReparadas));
        return true;
    } catch (error) {
        console.error('Error reparando catálogo:', error);
        return false;
    }
}

// Updated cargarCatalogoFaltas function
function cargarCatalogoFaltas() {
    try {
        const storedCatalog = localStorage.getItem('catalogoFaltas');
        
        // Si no existe el catálogo, inicializar con valores predeterminados
        if (!storedCatalog) {
            const defaultCatalog = FALTAS_PREDETERMINADAS.map(falta => ({
                ...falta,
                activa: true
            }));
            localStorage.setItem('catalogoFaltas', JSON.stringify(defaultCatalog));
            return defaultCatalog;
        }
        
        // Intentar reparar el catálogo si es necesario
        if (!repararCatalogoFaltas()) {
            console.warn('Reinicializando catálogo con valores predeterminados');
            const defaultCatalog = FALTAS_PREDETERMINADAS.map(falta => ({
                ...falta,
                activa: true
            }));
        ...
        console.error('Error cargando catálogo de faltas:', error);
        const defaultCatalog = FALTAS_PREDETERMINADAS.map(falta => ({
            ...falta,
            activa: true
        }));
...
// Initialize or reset fault catalog
function inicializarCatalogoFaltas() {
    try {
        const existingCatalog = localStorage.getItem('catalogoFaltas');
        ...
        if (!existingCatalog) {
            ...
            localStorage.setItem('catalogoFaltas', JSON.stringify(defaultCatalog));
            console.log('Fault catalog initialized with defaults');
            return;
        }
        
        // Validate existing catalog
        const faltas = JSON.parse(existingCatalog);
        if (!Array.isArray(faltas) || faltas.length === 0 || !validarEstructuraFaltas(faltas)) {
            console.warn('Invalid existing catalog, resetting to defaults');
            const defaultCatalog = FALTAS_PREDETERMINADAS.map(falta => ({
                ...falta,
                activa: true
            }));
        ...
        console.error('Error initializing fault catalog:', error);
        const defaultCatalog = FALTAS_PREDETERMINADAS.map(falta => ({
            ...falta,
            activa: true
        }));
...
// Add new fault to catalog
function agregarFalta(falta) {
    try {
        // Validate required fields
        if (!falta.descripcion || !falta.tipo) {
            throw new Error('Fault description and type are required');
        }
        
        // Create new fault object with defaults
        const nuevaFalta = {
            id: `${falta.tipo[0]}${Date.now()}`, // Create more meaningful IDs
            codigo: falta.codigo || '',
            descripcion: falta.descripcion.trim(),
            tipo: falta.tipo.toLowerCase(),
            activa: true
        };
        
        // Validate fault type
        if (!['leve', 'deficiente', 'eliminatoria'].includes(nuevaFalta.tipo)) {
...
function actualizarFalta(falta) {
    try {
        if (!falta.id) {
            throw new Error('Fault ID is required for updates');
        }
        
        const faltas = cargarCatalogoFaltas();
        const index = faltas.findIndex(f => f.id === falta.id);
        ...
        faltas[index] = {
            ...faltas[index],
            codigo: falta.codigo || faltas[index].codigo,
            descripcion: falta.descripcion?.trim() || faltas[index].descripcion,
            tipo: falta.tipo?.toLowerCase() || faltas[index].tipo,
            activa: falta.activa ?? faltas[index].activa
        };
...
// Delete fault from catalog
function eliminarFalta(id) {
    try {
        if (!id) {
            throw new Error('Fault ID is required for deletion');
        }
        
        const faltas = cargarCatalogoFaltas();
        const filteredFaltas = faltas.filter(f => f.id !== id);
        
        if (filteredFaltas.length === faltas.length) {
            throw new Error('Fault not found');
        }
        
        localStorage.setItem('catalogoFaltas', JSON.stringify(filteredFaltas));
        return true;
...
// Order faults by specified criterion
function ordenarFaltas(criterio = '') {
    try {
        ...
        switch (criterio.toLowerCase()) {
            ...
            case 'descripcion':
                return [...faltas].sort((a, b) => a.descripcion.localeCompare(b.descripcion));
            default:
                return faltas;
        }
    } catch (error) {
        console.error('Error ordering faults:', error);
        return cargarCatalogoFaltas();
    }
}

// Updated validation function to include active state
function validarEstructuraFaltas(faltas) {
    return faltas.every(falta => 
        falta.id && 
        typeof falta.codigo === 'string' &&
        typeof falta.descripcion === 'string' &&
        ['leve', 'deficiente', 'eliminatoria'].includes(falta.tipo.toLowerCase()) &&
        typeof falta.activa === 'boolean'
    );
}

// Nueva función para verificar el estado del catálogo
function verificarEstadoCatalogo() {
    try {
        const faltas = cargarCatalogoFaltas();
        const faltasActivas = faltas.filter(f => f.activa).length;
        
        return {
            total: faltas.length,
            activas: faltasActivas,
            inactivas: faltas.length - faltasActivas,
            tipos: {
                leves: faltas.filter(f => f.tipo === 'leve').length,
                deficientes: faltas.filter(f => f.tipo === 'deficiente').length,
                eliminatorias: faltas.filter(f => f.tipo === 'eliminatoria').length
            }
        };
    } catch (error) {
